## Case Study: Sensitivity to Last Level Cache Size
...
We have used a server system with a 16-core AMD EPYC 7313P processor, code-named Milan, which AMD launched in 2021. The main characteristics of this system are specified in table Table experimental_setup. 
...
Table: Main features of the server used in the experiments.
...
![The clustered memory hierarchy of the AMD Milan 7313P processor.](../../img/other-tuning/Milan7313P.png)
...
Table: Formulas for calculating metrics used in the case study.
...
![CPI, DMPKI, and MPKI for increasing LLC allocation limits (2 MB steps).](../../img/other-tuning/llc-bw.png)
