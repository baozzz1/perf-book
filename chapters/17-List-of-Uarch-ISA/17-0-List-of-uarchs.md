...
Table: List of the recent Intel Core microarchitectures.
...
Table: List of the recent AMD microarchitectures.
...
Table: List of recent ARM ISAs along with their own and third-party implementations.
